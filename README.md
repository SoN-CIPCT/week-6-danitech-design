[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/2DQCZKNS)
[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=22612808)
# Template-PythonWeek6
Repository template for Week 6 assignment on Python: If and While

## Assignment:
Create one Python file homework6_<firstname_lastname>.py and perform the following exercises:
### Conditional Lists:
Perform the following tasks to mimic how a website ensures everyone has a unique username.
...
If the user name does not already exist, print the message:
